...
export default function DayCard({ text, image }: DayCardProps) {
  return (
    <div className="bg-customGray md:w-[50%] w-[70%] md:h-[80%] h-[350px] text-3xl font-bold flex flex-col items-center mx-8 py-8 mt-24 2xl:mt-0 overflow-hidden rounded-2xl">
      <img
        src={image}
        alt="Day Image"
