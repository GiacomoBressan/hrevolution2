...
const Carousel: React.FC<CarouselProps> = ({ images }) => {
  return (
    <div className="w-full md:h-[90vh] h-[70vh] bg-customGreen flex items-center justify-center text-customBlue relative">
      <div className="bg-customGray xl:w-[1000px]  lg:h-[300px] lg:w-[900px] md:w-[680px] md:h-[250px] w-[350px] h-[185px] text-3xl p-6 pl-[10%] pr-[20%] relative md:mt-0 mt-14">
      ...
      <div className="bg-customGray xl:h-[500px] xl:w-[500px] lg:h-[420px] lg:w-[420px] md:h-[320px] md:w-[320px] h-[205px] w-[205px] absolute rounded-full md:translate-x-3/4 md:translate-y-1/4 md:top-0 top-12 flex justify-center items-center">
        <img
          src={images[0]}
          alt="Carousel Image"
